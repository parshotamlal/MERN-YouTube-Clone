    ...
    <div className=" h-14 flex items-center w-full justify-between top-0 fixed bg-black z-40 px-4">  
      ...
      <div className="flex items-center gap-4">                                     
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          <Link to={'/'} className="bg-red-500 flex justify-center items-center text-white rounded p-1">
     ...
     =<Link to={"/:id/upload"}>
     <FaVideo className="text-white cursor-pointer w-5 h-5 hover:bg-[#333]" /></Link>
        ...
        {navbarModal && (
          <div className="absolute top-[50px] right-4 w-48 z-20 bg-white text-black rounded shadow-lg">
            <div className="p-2 cursor-pointer hover:bg-gray-200" onClick={handleProfile}>Profile</div>
          <div className="p-2 cursor-pointer hover:bg-gray-200" onClick={() => onClickOnPopUpOption("logout")}>Logout</div>
    <div className="p-2 cursor-pointer hover:bg-gray-200" onClick={() => onClickOnPopUpOption("login")}>Login</div>
          </div>
        )}
      </div>
